...
export default function App() {
  ...
  const [userTier, setUserTier] = useState<UserTier>('premium'); // Defaulting to Premium for ideal preview experience, user can switch anytime
  ...
  useEffect(() => {
    ...
    if (payment === 'success' || status === 'completed' || checkout === 'success') {
      setUserTier('premium');
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs sm:text-sm text-slate-600 max-w-2xl font-normal">
            Ustvarite, upravljajte in analizirajte pametne QR kode na enem mestu.
          </p>
        </div>
