  ...
  return (
    <div className="sticky top-6 space-y-6">
      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-6 shadow-sm space-y-5">
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          ...
          {!isPremiumOrEnterprise && (
            <button
              ...
              className="text-[11px] font-semibold text-amber-700 bg-amber-50 hover:bg-amber-100 px-2.5 py-1 rounded-full border border-amber-200 transition-all flex items-center gap-1"
            >
        ...
        {/* DOT STYLES (Zaobljene, Pikčaste, Prestižne) - Locked & Blurred for Non-Premium */}
        <div className="relative">
          <label className="block text-[11px] font-semibold text-slate-600 mb-1.5">
            Prestižna struktura pik (Zaobljene, Pikčaste, Prestižne)
          </label>

          <div className={`grid grid-cols-3 gap-2 ${!isPremiumOrEnterprise ? 'blur-[2px] opacity-60 pointer-events-none' : ''}`}>
          ...
          {!isPremiumOrEnterprise && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/10 backdrop-blur-xs rounded-xl p-2 text-center">
              <div className="flex items-center gap-1.5 bg-slate-900 text-white px-3 py-1 rounded-full text-[11px] font-semibold shadow-md">
                <Lock className="w-3 h-3 text-amber-400" />
                Odklene se v Premium paketu
              </div>
            </div>
          )}
        </div>

        {/* LOGO UPLOAD ZONE - Locked & Blurred for Non-Premium */}
        <div className="relative">
          <label className="block text-[11px] font-semibold text-slate-600 mb-1.5">
          ...
          <div
            className={`p-4 border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/60 text-center space-y-2 ${
              !isPremiumOrEnterprise ? 'blur-[2px] opacity-60 pointer-events-none' : ''
            }`}
          >
            <UploadCloud className="w-6 h-6 text-slate-400 mx-auto" />
            <p className="text-xs text-slate-600 font-medium">
              Povlecite in ispustite logotip PNG/SVG ali vnesite URL
            </p>
            <input
              type="text"
          ...
          {!isPremiumOrEnterprise && (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/10 backdrop-blur-xs rounded-2xl p-3 text-center">
              <div className="flex items-center gap-1.5 bg-slate-900 text-white px-3 py-1.5 rounded-full text-xs font-semibold shadow-md mb-1">
                <Lock className="w-3.5 h-3.5 text-amber-400" />
                Nalaganje lastnega logotipa
              </div>
