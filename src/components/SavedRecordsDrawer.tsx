          ...
          <div className="bg-white rounded-3xl p-6 max-w-md w-full shadow-2xl border border-slate-200 space-y-5 relative">
            ...
            {interceptModal.type === 'limit_uporabnik' && (
              <div className="space-y-4 text-center pt-2">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-extrabold text-slate-900">
                    Dosežena meja map po meri
                  </h3>
                  <p className="text-xs text-slate-600 leading-relaxed font-medium bg-slate-50 p-3 rounded-2xl border border-slate-200/80">
                    Dosegli ste mejo 3 map po meri v brezplačnem paketu Uporabnik. Nadgradite v Premium (19 €/mesec) za do 20 map po meri.
                  </p>
                </div>
                <div className="pt-2 flex flex-col gap-2">
                  <button
            ...
            {interceptModal.type === 'limit_premium' && (
              <div className="space-y-4 text-center pt-2">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-600 leading-relaxed font-medium bg-slate-50 p-3 rounded-2xl border border-slate-200/80">
                    Dosegli ste mejo 20 map po meri v paketu Premium. Zaščita pomnilnika strežnika omogoča do 20 map. Kontaktirajte Enterprise za neomejeno ustvarjanje map.
                  </p>
                </div>
                <div className="pt-2 flex flex-col gap-2">
                  <button
